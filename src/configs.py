...
NUM_THREADS = 16 *4 # default = 0, 0 means default number of threads in OpenMP, for the best speed, set this to the number of real CPU cores, not the number of threads
DEVICE = 'cpu'#'cuda'
...
PARAMS_GB = { 'objective': OBJECTIVE,
              ...
              'metric': METRIC,
              'verbosity':VERBOSITY,
              #'gpu_device_id': 1, 'gpu_platform_id': 0, 'gpu_use_dp': False, 'max_bin': 63
              #'gpu_device_id':2
              }